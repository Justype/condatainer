...
// Priority:
//  1. Scheduler-specific local node storage: SLURM_TMPDIR, PBS_TMPDIR, LSF_TMPDIR, _CONDOR_SCRATCH_DIR
//  2. Common tmp env vars: TMPDIR, TEMP, TMP
//  3. /tmp (always available)
//
...
func GetTmpDir() string {
	...
	// Priority 1: scheduler-assigned local node storage (fast per-job scratch)
	...
	// Priority 2: common tmp env vars
