...
- `condatainer info <overlay>` — shows the description of a built overlay. This is read from the `#WHATIS:` line of the build script embedded inside the overlay (a sidecar `.env`, if present, overrides it).
