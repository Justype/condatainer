#!/usr/bin/env python3
"""
Query the Docker Hub to generate ubuntu22/*def files

- R related => query posit/r-base tags
    - For we look for tags like 4.4.3-jammy-{arch} => 4.4.3-jammy in r4.4.3.def
    python3 build-scripts/ubuntu22/auto.py # to generate new files
    rm build-scripts/ubuntu22/r*.def # to remove generated files
"""
